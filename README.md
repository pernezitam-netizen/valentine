...
<body>
  ...
  <main class="card">
    ...
    <h1> Good morning Gabs, will you be my one and only valentine?</h1>
    ...
    <section class="result" id="result">
      ...
      <img
        class="fireworks"
        src="https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExOGJ3cXBiMndrMWh6dGJkYmM3NzEyYXZyODk5NjJxaHduY3YwN2VwaiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/yPjxAzSkVFgZO/giphy.gif"
        alt="Fireworks"
      />
    </section>
  </main>
